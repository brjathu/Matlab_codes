...
MAKECMD         = /home/brjathu/Softwares/Matlab/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = ssp2
MODULES                = rtGetInf.c rtGetNaN.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_logging.c rt_logging_mmi.c rt_lu_real.c rt_matrixlib_dbl.c rt_nonfinite.c rtw_modelmap_utils.c ssp2_3b3f044c_1.c ssp2_3b3f044c_1_ds.c ssp2_3b3f044c_gateway.c ssp2_capi.c 
MAKEFILE               = ssp2.mk
MATLAB_ROOT            = /home/brjathu/Softwares/Matlab
ALT_MATLAB_ROOT        = /home/brjathu/Softwares/Matlab
MATLAB_ROOTQ           = \"/home/brjathu/Softwares/Matlab\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/brjathu/Softwares/Matlab/myfiles/SS/P2
S_FUNCTIONS            = rtiostream_utils.c
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNXA64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/home/brjathu/Softwares/Matlab" EXT_MODE=1 OPTS="-DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(MATLAB_ROOT)/myfiles/SS/P2/slprj/raccel/ssp2 \
	-I$(MATLAB_ROOT)/myfiles/SS/P2 \
